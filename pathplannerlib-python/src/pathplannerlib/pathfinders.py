...
class LocalADStar(Pathfinder):
    ...
    def getCurrentPath(self, constraints: PathConstraints, goal_end_state: GoalEndState) -> Union[PathPlannerPath, None]:
        """
    ...
    def _doWork(self, needs_reset: bool, do_minor: bool, do_major: bool, s_start: GridPosition, s_goal: GridPosition, real_start_pos: Translation2d, real_goal_pos: Translation2d, obstacles: Set[GridPosition]) -> None:
        pass # TODO
    ...
    def _updateState(self, s: GridPosition, s_start: GridPosition, s_goal: GridPosition, obstacles: Set[GridPosition]) -> None:
        if s != s_goal:
