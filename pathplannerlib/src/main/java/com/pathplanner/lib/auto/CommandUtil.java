...
public class CommandUtil {
    ...
    public static Command wrappedEventCommand(Command eventCommand) {
        return new FunctionalCommand(eventCommand::initialize, eventCommand::execute, eventCommand::end, eventCommand::isFinished, eventCommand.getRequirements().toArray(Subsystem[]::new));
    }
     ...
     */
    public static Command commandFromJson(JSONObject commandJson, boolean loadChoreoPaths, boolean mirror) throws IOException, ParseException {
        String type = (String) commandJson.get("type");
        JSONObject data = (JSONObject) commandJson.get("data");
        return switch(type) {
            case "wait" ->
                waitCommandFromData(data);
            case "named" ->
                namedCommandFromData(data);
            case "path" ->
                pathCommandFromData(data, loadChoreoPaths, mirror);
            case "sequential" ->
                sequentialGroupFromData(data, loadChoreoPaths, mirror);
            case "parallel" ->
                parallelGroupFromData(data, loadChoreoPaths, mirror);
            case "race" ->
                raceGroupFromData(data, loadChoreoPaths, mirror);
            case "deadline" ->
                deadlineGroupFromData(data, loadChoreoPaths, mirror);
            default ->
                Commands.none();
        };
    }
    ...
    private static Command pathCommandFromData(JSONObject dataJson, boolean choreoPath, boolean mirror) throws IOException, ParseException {
        String pathName = (String) dataJson.get("pathName");
        PathPlannerPath path = choreoPath ? PathPlannerPath.fromChoreoTrajectory(pathName) : PathPlannerPath.fromPathFile(pathName);
        if (mirror) {
    ...
    private static Command sequentialGroupFromData(JSONObject dataJson, boolean loadChoreoPaths, boolean mirror) throws IOException, ParseException {
    ...
    private static Command parallelGroupFromData(JSONObject dataJson, boolean loadChoreoPaths, boolean mirror) throws IOException, ParseException {
    ...
    private static Command raceGroupFromData(JSONObject dataJson, boolean loadChoreoPaths, boolean mirror) throws IOException, ParseException {
    ...
    private static Command deadlineGroupFromData(JSONObject dataJson, boolean loadChoreoPaths, boolean mirror) throws IOException, ParseException {
