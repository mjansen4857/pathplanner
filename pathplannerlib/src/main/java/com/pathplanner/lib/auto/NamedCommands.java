...
public class NamedCommands {
    ...
    public static Command getCommand(String name) {
        if (hasCommand(name)) {
            ...
            DriverStationErrors.reportWarning("PathPlanner attempted to create a command '" + name + "' that has not been registered with NamedCommands.registerCommand", false);
