...
public class ModuleConfig {
     ...
     *     is usually 2.
     */
    public ModuleConfig(double wheelRadiusMeters, double maxDriveVelocityMPS, double wheelCOF, org.wpilib.math.system.DCMotor driveMotor, double driveCurrentLimit, int numMotors) {
        ...
        this.torqueLoss = Math.max(this.driveMotor.getTorque(Math.min(maxSpeedCurrentDraw, this.driveCurrentLimit)), 0.0);
    }
     ...
     *     is usually 2.
     */
    public ModuleConfig(Distance wheelRadius, LinearVelocity maxDriveVelocity, double wheelCOF, org.wpilib.math.system.DCMotor driveMotor, Current driveCurrentLimit, int numMotors) {
        this(wheelRadius.in(Meters), maxDriveVelocity.in(MetersPerSecond), wheelCOF, driveMotor, driveCurrentLimit.in(Amps), numMotors);
    }
     ...
     *     is usually 2.
     */
    public ModuleConfig(double wheelRadiusMeters, double maxDriveVelocityMPS, double wheelCOF, org.wpilib.math.system.DCMotor driveMotor, double driveGearing, double driveCurrentLimit, int numMotors) {
        this(wheelRadiusMeters, maxDriveVelocityMPS, wheelCOF, driveMotor.withReduction(driveGearing), driveCurrentLimit, numMotors);
    }
     ...
     *     is usually 2.
     */
    public ModuleConfig(Distance wheelRadius, LinearVelocity maxDriveVelocity, double wheelCOF, org.wpilib.math.system.DCMotor driveMotor, double driveGearing, Current driveCurrentLimit, int numMotors) {
        this(wheelRadius.in(Meters), maxDriveVelocity.in(MetersPerSecond), wheelCOF, driveMotor.withReduction(driveGearing), driveCurrentLimit.in(Amps), numMotors);
    }
}
