...
public record PathConstraints(double maxVelocityMPS, double maxAccelerationMPSSq, double maxAngularVelocityRadPerSec, double maxAngularAccelerationRadPerSecSq, double nominalVoltageVolts, boolean unlimited) {
     ...
     * @param unlimited Should the constraints be unlimited
     */
    public PathConstraints(LinearVelocity maxVelocity, LinearAcceleration maxAcceleration, AngularVelocity maxAngularVelocity, AngularAcceleration maxAngularAcceleration, Voltage nominalVoltage, boolean unlimited) {
        this(maxVelocity.in(MetersPerSecond), maxAcceleration.in(MetersPerSecondPerSecond), maxAngularVelocity.in(RadiansPerSecond), maxAngularAcceleration.in(RadiansPerSecondPerSecond), nominalVoltage.in(Volts), unlimited);
    }
    ...
    public PathConstraints(double maxVelocityMPS, double maxAccelerationMPSSq, double maxAngularVelocityRadPerSec, double maxAngularAccelerationRadPerSecSq, double nominalVoltageVolts) {
        this(maxVelocityMPS, maxAccelerationMPSSq, maxAngularVelocityRadPerSec, maxAngularAccelerationRadPerSecSq, nominalVoltageVolts, false);
    }
     ...
     * @param nominalVoltage The nominal battery voltage
     */
    public PathConstraints(LinearVelocity maxVelocity, LinearAcceleration maxAcceleration, AngularVelocity maxAngularVelocity, AngularAcceleration maxAngularAcceleration, Voltage nominalVoltage) {
        this(maxVelocity, maxAcceleration, maxAngularVelocity, maxAngularAcceleration, nominalVoltage, false);
    }
    ...
    public PathConstraints(double maxVelocityMPS, double maxAccelerationMPSSq, double maxAngularVelocityRadPerSec, double maxAngularAccelerationRadPerSecSq) {
        this(maxVelocityMPS, maxAccelerationMPSSq, maxAngularVelocityRadPerSec, maxAngularAccelerationRadPerSecSq, 12.0, false);
    }
     ...
     * @param maxAngularAcceleration Max angular acceleration
     */
    public PathConstraints(LinearVelocity maxVelocity, LinearAcceleration maxAcceleration, AngularVelocity maxAngularVelocity, AngularAcceleration maxAngularAcceleration) {
        this(maxVelocity, maxAcceleration, maxAngularVelocity, maxAngularAcceleration, Volts.of(12.0), false);
    }
    ...
    public static PathConstraints unlimitedConstraints(double nominalVoltage) {
        return new PathConstraints(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, nominalVoltage, true);
    }
    ...
    static PathConstraints fromJson(JSONObject constraintsJson) {
        ...
        return new PathConstraints(maxVel, maxAccel, Units.degreesToRadians(maxAngularVel), Units.degreesToRadians(maxAngularAccel), nominalVoltage, unlimited);
    }
