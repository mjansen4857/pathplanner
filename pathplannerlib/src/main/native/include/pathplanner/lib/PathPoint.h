...
namespace pathplanner
{
    ...
    public:
        ...
        constexpr PathPoint(frc::Translation2d position, frc::Rotation2d heading, frc::Rotation2d holonomicRotation, units::meters_per_second_t velocityOverride) : m_position(position),
                                                                                                                                                                    m_heading(heading),
                                                                                                                                                                    m_holonomicRotation(holonomicRotation),
                                                                                                                                                                    m_velocityOverride(velocityOverride) {}

        constexpr PathPoint(frc::Translation2d position, frc::Rotation2d heading, frc::Rotation2d holonomicRotation) : PathPoint(position, heading, holonomicRotation, -1_mps) {}

        constexpr PathPoint(frc::Translation2d position, frc::Rotation2d heading, units::meters_per_second_t velocityOverride) : PathPoint(position, heading, frc::Rotation2d(), velocityOverride) {}

        constexpr PathPoint(frc::Translation2d position, frc::Rotation2d heading) : PathPoint(position, heading, frc::Rotation2d(), -1_mps) {}
