...
public class GeometryUtilTest {
    ...
    public void testRotationLerp(){
        assertEquals(90, GeometryUtil.rotationLerp(Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(180), 0.5).getDegrees(), DELTA);
        assertEquals(-45, GeometryUtil.rotationLerp(Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(-180), 0.25).getDegrees(), DELTA);
    }

    @Test
    public void testTranslationLerp(){
        Translation2d t = GeometryUtil.translationLerp(new Translation2d(2.3, 7), new Translation2d(3.5, 2.1), 0.2);
    ...
    public void testQuadraticLerp(){
        Translation2d t = GeometryUtil.quadraticLerp(new Translation2d(1, 2), new Translation2d(3, 4), new Translation2d(5, 6), 0.5);
    ...
    public void testCubicLerp(){
        Translation2d t = GeometryUtil.cubicLerp(new Translation2d(1, 2), new Translation2d(3, 4), new Translation2d(5, 6), new Translation2d(7, 8), 0.5);
