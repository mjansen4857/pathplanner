...
TEST(GeometryUtilTest, TestUnitLerp) {
	...
	EXPECT_DOUBLE_EQ(12, GeometryUtil::unitLerp(wpi::units::curvature_t {10}, wpi::units::curvature_t {20}, 0.2)());
}
...
TEST(GeometryUtilTest, TestCalculateRadius) {
	EXPECT_NEAR(-0.5, GeometryUtil::calculateRadius(wpi::math::Translation2d(1_m, 1_m), wpi::math::Translation2d(1.5_m, 1.5_m), wpi::math::Translation2d(2.0_m, 1_m))(), 0.001);
	EXPECT_NEAR(0.5, GeometryUtil::calculateRadius(wpi::math::Translation2d(1_m, 1_m), wpi::math::Translation2d(1.5_m, 0.5_m), wpi::math::Translation2d(2.0_m, 1_m))(), 0.001);
	EXPECT_NEAR(-0.625, GeometryUtil::calculateRadius(wpi::math::Translation2d(1_m, 1_m), wpi::math::Translation2d(1.5_m, 1.25_m), wpi::math::Translation2d(2.0_m, 1_m))(), 0.001);
	EXPECT_NEAR(0.625, GeometryUtil::calculateRadius(wpi::math::Translation2d(1_m, 1_m), wpi::math::Translation2d(1.5_m, 0.75_m), wpi::math::Translation2d(2.0_m, 1_m))(), 0.001);
}