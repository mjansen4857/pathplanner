...
test('Generation Succeeds', () => {
    var path = new RobotPath([new Vector2(0, 0), new Vector2(5, 0), new Vector2(5, 5), new Vector2(10, 5)], [-1, -1], [0, 0], {maxVel: 12, maxAcc: 8, wheelbaseWidth: 2, timeStep: 0.01}, false, true);
