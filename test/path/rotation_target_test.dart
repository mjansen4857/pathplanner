...
void main() {
  ...
  test('equals/hashCode', () {
    RotationTarget t1 = RotationTarget(1.0, Rotation2d(2.0));
    RotationTarget t2 = RotationTarget(1.0, Rotation2d(2.0));
    RotationTarget t3 = RotationTarget(1.5, Rotation2d(2.5));
