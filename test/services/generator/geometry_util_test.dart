...
void main() {
  ...
  group('pointLerp', () {
    test('(2.3, 7) to (3.5, 2.1), t = 0.2', () {
      expect(GeometryUtil.pointLerp(Point(2.3, 7), Point(3.5, 2.1), 0.2),
          Point(2.54, 6.02));
    });

    test('(-1.5, 2) to (1.5, -3), t = 0.5', () {
      expect(GeometryUtil.pointLerp(Point(-1.5, 2), Point(1.5, -3), 0.5),
          Point(0, -0.5));
    });
  });
    ...
    test('(1, 2), (3, 4), (5, 6), t = 0.5', () {
      expect(
          GeometryUtil.quadraticLerp(
              Point(1, 2), Point(3, 4), Point(5, 6), 0.5),
          Point(3, 4));
    });
  });
    ...
    test('(1, 2), (3, 4), (5, 6), (7, 8), t = 0.5', () {
      expect(
          GeometryUtil.cubicLerp(
              Point(1, 2), Point(3, 4), Point(5, 6), Point(7, 8), 0.5),
          Point(4, 5));
    });
  });
